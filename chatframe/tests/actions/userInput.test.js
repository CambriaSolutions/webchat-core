...
test('creates a user response from input and save user input', () => {
 const store = mockStore({
   ...
   store.dispatch(actions.submitUserInput())
    ...
    const expectedActions =   [{"response": {"entity": "user", "messageId": "usermessage-0", "systemTime": storedActions[0].response.systemTime, "text": "testing"}, "type": "SAVE_USER_RESPONSE"}, {"type": "HIDE_BUTTON_BAR"}, {"type": "INITIATE_LOADING"}, {"type": "SAVE_USER_INPUT", "value": ""}]
