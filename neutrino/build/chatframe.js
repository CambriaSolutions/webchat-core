...
`;class pn extends z.PureComponent{componentDidMount(){var e=this.props;const t=e.setFeedbackOptions,a=e.feedbackData;t(a)}render(){var e=this.props;const t=e.session,a=e.className,n=e.key;return Object(z.createElement)(mn,{className:a,key:n},Object(z.createElement)(un,{session:t}))}}var yn=Object(A.connect)((e)=>({feedbackInputs:e.feedbackInput}),(e)=>({setFeedbackOptions:(t)=>{e(x(t))}}))(pn);const Mn={giant:1170,desktop:992,tablet:768,phone:620},Nn=Object.keys(Mn).reduce((e,t)=>{const a=Mn[t]/16;return e[t]=(...e)=>Y.css`
...
`;class hn extends z.PureComponent{constructor(){super(),this.handleKeyPress=this.handleKeyPress.bind(this)}handleKeyPress(t){13===t.charCode&&(this.props.submitUserInput(),t.preventDefault())}render(){var e=this.props;const t=e.saveUserInput,a=e.inputValue,n=e.shouldDisable,i=a.value,o=`${a.charLength}/255`,r=a.maxExceeded;let s=null;return s=r?`Exceeded character limit: ${o}`:null,Object(z.createElement)(Cn,{visible:n},Object(z.createElement)(In,{multiline:!0,rowsMax:'4',fullWidth:!0,InputProps:{disableUnderline:!0},placeholder:'Send a message',helperText:s,FormHelperTextProps:{style:{color:'#cd5c5c',margin:0}},onChange:t,value:i,onKeyPress:this.handleKeyPress}),Object(z.createElement)(wn,{onClick:this.props.submitUserInput,"aria-label":'Send',color:'primary',disabled:r,disableRipple:!0},Object(z.createElement)(xn.a,null)))}}var bn=Object(A.connect)((e)=>({inputValue:e.userInput,shouldDisable:e.conversation.disableInput}),(t)=>({saveUserInput:(a)=>{t(v(a.target.value))},submitUserInput:()=>{t(k())}}))(hn),Dn=a(62),Sn=a.n(Dn);const vn=R.a.div`
  grid-area: buttonbar;
  display: flex;
  flex-flow: row wrap;
...
`;class zn extends z.PureComponent{render(){var e=this.props;const t=e.visible,a=e.messages,n=e.sendQuickReply,i=Sn()(a,(e)=>{const t=qe()(e.responses,['type','suggestion']);return t}),o=[];if(i){const e=i.responses.filter((e)=>'suggestion'===e.type);for(const a of e)for(const e of a.suggestions)o.push({label:e,id:i.messageId,visible:t})}return Object(z.createElement)(vn,{visible:t},o.map((e,t)=>Object(z.createElement)(kn,{size:'small',variant:'outlined',color:'secondary',key:`${e.id}-btn${t}`,visible:e.visible.toString(),onClick:()=>n(e.label)},e.label)))}}var On=Object(A.connect)((e)=>({visible:e.buttonBar.visible,messages:e.conversation.messages}),(e)=>({sendQuickReply:(t)=>{e(p(t))}}))(zn);const An=R()(ut.a)`
  && {
    width: 400px;
    height: 70vh;
    max-height: 600px;
...
`;class Un extends z.PureComponent{constructor(e){super(e),this.containerRef=O.a.createRef()}render(){var e=this.props;const t=e.windowVisible,a=e.fullscreen;return Object(z.createElement)(An,{elevation:4,fullscreen:a?1:0,visible:t?1:0},Object(z.createElement)(Pn,{ref:this.containerRef,className:'mui-fixed'},Object(z.createElement)(kt,null),Object(z.createElement)(Jt,{parentRef:this.containerRef.current}),Object(z.createElement)(fn,null),Object(z.createElement)(On,null),Object(z.createElement)(bn,null)))}}var Qn=Object(A.connect)((e)=>({windowVisible:e.config.windowVisible,fullscreen:e.config.fullscreen}))(Un),Yn=Object.assign||function(e){for(var t,a=1;a<arguments.length;a++)for(var n in t=arguments[a],t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e};const Rn={avatar:null,title:'Chat Window',windowVisible:!1,fullscreen:!1,privacyPolicyVisible:!1,googleMapsKey:'',centerCoordinates:'',activationText:'',privacyPolicy:'Please do not enter any personally identifiable information such as SSN, Date of Birth, Case Number or last name.',feedbackUrl:''};var Vn=Object.assign||function(e){for(var t,a=1;a<arguments.length;a++)for(var n in t=arguments[a],t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e};const _n={client:null,clientName:null,messages:[],webhookPayload:null,disableInput:!1,lastUpdateTime:Object(pe.format)(new Date,Ze),currentTime:Object(pe.format)(new Date,Ze),headerTime:'Now',timer:null,conversationStarted:!1};var Bn=Object.assign||function(e){for(var t,a=1;a<arguments.length;a++)for(var n in t=arguments[a],t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e};const Wn={visible:!1,buttons:[]};const Gn={value:'',charLength:0,maxExceeded:!1};var Fn=Object.assign||function(e){for(var t,a=1;a<arguments.length;a++)for(var n in t=arguments[a],t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n]);return e};const Jn={submitted:!1,wasHelpful:null,feedbackList:null};const Zn='';const Hn=Object(U.combineReducers)({config:function(e=Rn,t){switch(t.type){case Qe:return Yn({},e,{privacyPolicyVisible:!1});case Ue:return Yn({},e,{privacyPolicyVisible:!0});case Ye:return Yn({},e,{privacyPolicy:t.policyText});case Re:return Yn({},e,{googleMapsKey:t.googleMapsKey});case Ve:return Yn({},e,{centerCoordinates:t.centerCoordinates});case _e:return Yn({},e,{activationText:t.activationText});case Ne:return Yn({},e,{avatar:t.avatar});case Me:return Yn({},e,{title:t.title});case be:return Yn({},e,{windowVisible:!0});case De:return Yn({},e,{windowVisible:!1});case Se:return Yn({},e,{fullscreen:!0});case ve:return Yn({},e,{fullscreen:!1});case We:return Yn({},e,{feedbackUrl:t.feedbackUrl});default:return e;}},conversation:function(e=_n,t){switch(t.type){case ge:return Vn({},e,{client:t.client,clientName:t.clientName});case xe:return Vn({},e,{headerTime:t.headerTime,currentTime:t.currentTime});case je:return Vn({},e,{timer:t.timer});case fe:return Vn({},e,{messages:[...e.messages,{loading:!0,entity:'bot',systemTime:Object(pe.format)(new Date,Ze)}]});case Le:return Vn({},e,{lastUpdateTime:Object(pe.format)(new Date,Ze),headerTime:'Now',messages:t.newConversationArray});case Ee:return Vn({},e,{lastUpdateTime:Object(pe.format)(new Date,Ze),headerTime:'Now',messages:[...e.messages,Vn({},t.response,{key:Ke()()})].sort((e,t)=>{const a=Object(pe.parse)(e.systemTime,Ze,new Date(e.systemTime)),n=Object(pe.parse)(t.systemTime,Ze,new Date(t.systemTime)),i=Object(pe.differenceInMilliseconds)(n,a);return i})});case ke:return Vn({},e,{webhookPayload:t.payload});case Oe:return Vn({},e,{disableInput:!1});case ze:return Vn({},e,{disableInput:!0});case Ae:return Vn({},e,{conversationStarted:!0});case Pe:return Vn({},e,{conversationStarted:!1});case Je:return Vn({},e,{outputContexts:t.rawOutputContexts});default:return e;}},buttonBar:function(e=Wn,t){switch(t.type){case Ce:return Bn({},e,{visible:!0});case Ie:return Bn({},e,{visible:!1});default:return e;}},userInput:function(e=Gn,t){switch(t.type){case Te:return t.userInput;default:return e;}},feedbackInput:function(e=Jn,t){switch(t.type){case Be:return Fn({},e,{feedbackList:e.feedbackList.map((e)=>e.value===t.value.value?Fn({},e,{checked:t.value.checked}):e)});case Fe:return Fn({},e,{wasHelpful:t.value.helpful,feedbackList:t.value.options.map((e)=>Fn({},e,{checked:!1}))});case Ge:return Fn({},e,{submitted:!0});default:return e;}},error:function(e=Zn,t){switch(t.type){case we:return t.error;case he:return Zn;default:return e;}}});_.a.load({google:{families:['Roboto:300,400,500','Product Sans:400']}});const Kn=R.a.div`
  width: 100%;
  height: 100%;
  pointer-events: none;
  position: fixed;
