...
`;class Qt extends w.PureComponent{render(){var e=this.props;const t=e.message,i=e.entity,n=e.isLoading,a=e.timestamp,r=e.currentTime,s=e.theme,o=Object(ie.parse)(r,je,new Date(r)),l=Object(ie.parse)(a,je,new Date(r)),c=Object(ie.differenceInMinutes)(o,l),d=Object(ie.differenceInSeconds)(o,l);let m=null;m=1<=c?`${c} min`:10<=d?`${d} sec`:'Now';const u='user'===i?Object(w.createElement)(Wt,{elevation:1,theme:s},Object(w.createElement)(Ze.a,{variant:'body1'},t)):Object(w.createElement)(Gt,{elevation:1},n?Object(w.createElement)(kt,null):Object(w.createElement)(Ze.a,{variant:'body1'},t));return Object(w.createElement)(Ut,{entity:i},Object(w.createElement)(At,{entity:i},u),Object(w.createElement)(Ht,{variant:'caption'},m))}}var Zt=Object(Z.withTheme)()(Object(v.connect)((e)=>({currentTime:e.conversation.currentTime}))(Qt)),Vt=i(41),Ft=i.n(Vt),Bt=i(42),Xt=i.n(Bt),_t=i(43),Jt=i.n(_t),Kt=i(44),qt=i.n(Kt);const $t=O()(Ft.a)`
  && {
    border-top-left-radius: 10px;
    border-top-right-radius: 10px;
    border-bottom-right-radius: 10px;
...
`;class ui extends w.PureComponent{constructor(){super(),this.handleKeyPress=this.handleKeyPress.bind(this)}handleKeyPress(t){13===t.charCode&&this.props.submitUserInput()}render(){var e=this.props;const t=e.saveUserInput,i=e.inputValue;return Object(w.createElement)(di,null,Object(w.createElement)(mi,{fullWidth:!0,disableUnderline:!0,placeholder:'Send a message',onChange:t,value:i,onKeyPress:this.handleKeyPress}),Object(w.createElement)(et.a,{onClick:this.props.submitUserInput,"aria-label":'Send',color:'primary'},Object(w.createElement)(oi.a,null)))}}var pi=Object(v.connect)((e)=>({inputValue:e.userInput}),(t)=>({saveUserInput:(i)=>{t(h(i.target.value))},submitUserInput:()=>{t(E())}}))(ui),yi=i(47),Mi=i.n(yi);const gi=O.a.div`
  grid-area: buttonbar;
  display: flex;
  flex-flow: row wrap;
