...
`;class Ut extends O.PureComponent{render(){var e=this.props;const t=e.title,n=e.theme,a=e.hideWindow,i=e.showWindowed,o=e.showFullscreen,s=e.fullscreen,r=e.avatar,l=e.showPrivacyPolicy,c=e.sendQuickReply,d=e.messages,u=Object(vt.findLast)(d,(e)=>{const t=Object(vt.find)(e.responses,['type','suggestion']);return t});let m=null;if(u){const e=u.responses.filter((e)=>'suggestion'===e.type)[0].suggestions;m=Object(vt.find)(e,(e)=>'home'===e.toLowerCase())}return Object(O.createElement)(kt,{theme:n},Object(O.createElement)(St,{alt:t,src:r}),Object(O.createElement)(zt,{theme:n,variant:'h6'},t),m&&Object(O.createElement)(ht.a,{title:'Return to subject selection',placement:'bottom'},Object(O.createElement)(Pt,{theme:n,onClick:()=>c('START OVER')},'Start Over')),Object(O.createElement)(ht.a,{title:'Privacy Policy',placement:'bottom'},Object(O.createElement)(Ot,{theme:n,onClick:l,"aria-label":'Windowed'},Object(O.createElement)(Et.a,{fontSize:'small'}))),s?Object(O.createElement)(Ot,{theme:n,onClick:i,"aria-label":'Windowed'},Object(O.createElement)(Tt.a,{fontSize:'small'})):Object(O.createElement)(Ot,{theme:n,onClick:o,"aria-label":'Fullscreen'},Object(O.createElement)(gt.a,{fontSize:'small'})),Object(O.createElement)(Ot,{theme:n,onClick:a,"aria-label":'Close'},Object(O.createElement)(bt.a,{fontSize:'small'})))}}var At=Object(q.withTheme)()(Object(U.connect)((e)=>({title:e.config.title,fullscreen:e.config.fullscreen,avatar:e.config.avatar,messages:e.conversation.messages}),(e)=>({hideWindow:g,showFullscreen:L,showWindowed:T,showPrivacyPolicy:M,sendQuickReply:(t)=>e(p(t))}))(Ut)),Yt=n(40),Rt=n.n(Yt),Qt=n(41),Vt=n.n(Qt),Bt=n(42),_t=n.n(Bt),Wt=n(43),Gt=n.n(Wt),Ht=n(44),Jt=n.n(Ht);const Zt=V()(Vt.a)`
  && {
    position: absolute;
  }
