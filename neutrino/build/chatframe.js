...
`;class Ut extends O.PureComponent{render(){var e=this.props;const t=e.title,n=e.theme,a=e.hideWindow,i=e.showWindowed,o=e.showFullscreen,s=e.fullscreen,r=e.avatar,l=e.showPrivacyPolicy,c=e.sendQuickReply,d=e.messages,u=Object(vt.findLast)(d,(e)=>{const t=Object(vt.find)(e.responses,['type','suggestion']);return t});let m=null;if(u){const e=u.responses.filter((e)=>'suggestion'===e.type)[0].suggestions;m=Object(vt.find)(e,(e)=>'home'===e.toLowerCase())}return Object(O.createElement)(kt,{theme:n},Object(O.createElement)(St,{alt:t,src:r}),Object(O.createElement)(zt,{theme:n,variant:'h6'},t),m&&Object(O.createElement)(ht.a,{title:'Return to subject selection',placement:'bottom'},Object(O.createElement)(Pt,{theme:n,onClick:()=>c('HOME')},'Start Over')),Object(O.createElement)(ht.a,{title:'Privacy Policy',placement:'bottom'},Object(O.createElement)(Ot,{theme:n,onClick:l,"aria-label":'Windowed'},Object(O.createElement)(Et.a,{fontSize:'small'}))),s?Object(O.createElement)(Ot,{theme:n,onClick:i,"aria-label":'Windowed'},Object(O.createElement)(Tt.a,{fontSize:'small'})):Object(O.createElement)(Ot,{theme:n,onClick:o,"aria-label":'Fullscreen'},Object(O.createElement)(gt.a,{fontSize:'small'})),Object(O.createElement)(Ot,{theme:n,onClick:a,"aria-label":'Close'},Object(O.createElement)(bt.a,{fontSize:'small'})))}}var At=Object(q.withTheme)()(Object(U.connect)((e)=>({title:e.config.title,fullscreen:e.config.fullscreen,avatar:e.config.avatar,messages:e.conversation.messages}),(e)=>({hideWindow:g,showFullscreen:L,showWindowed:T,showPrivacyPolicy:M,sendQuickReply:(t)=>e(p(t))}))(Ut)),Yt=n(40),Rt=n.n(Yt),Qt=n(41),Vt=n.n(Qt),Bt=n(42),_t=n.n(Bt),Wt=n(43),Gt=n.n(Wt),Ht=n(44),Jt=n.n(Ht);const Zt=V()(Vt.a)`
  && {
    position: absolute;
  }
`;class Ft extends O.PureComponent{render(){var e=this.props;const t=e.hidePrivacyPolicy,n=e.privacyPolicyVisible,a=e.privacyPolicy,i=e.parentRef;return Object(O.createElement)(Zt,{open:n,onClose:t,"aria-labelledby":'privacy-policy',container:i,scroll:'paper'},Object(O.createElement)(Rt.a,null,'Privacy Statement'),Object(O.createElement)(Gt.a,null,Object(O.createElement)(Jt.a,null,a)),Object(O.createElement)(_t.a,null,Object(O.createElement)(wt.a,{onClick:t,color:'primary'},'Close')))}}var Kt=Object(U.connect)((e)=>({privacyPolicyVisible:e.config.privacyPolicyVisible,privacyPolicy:e.config.privacyPolicy}),{hidePrivacyPolicy:function(){return{type:Re}}})(Ft),Xt=n(45),qt=n.n(Xt),$t=n(46),en=n.n($t),tn=n(17),nn=n.n(tn),an=n(10),on=n.n(an),sn=n(47),rn=n.n(sn);const ln=V.a.div`
  text-align: center;
  width: 42px;
  height: 100%;
  display: flex;
...
`;class wn extends O.PureComponent{render(){var e=this.props.data;const t=e.title,n=e.subtitle,a=e.imageUrl,i=e.buttons,o=e.className;return Object(O.createElement)(hn,{className:o,key:this.props.key},a?Object(O.createElement)(Cn,{image:encodeURI(a),title:''}):null,Object(O.createElement)(xn.a,null,Object(O.createElement)(yt.a,{gutterBottom:!0,variant:'h6'},t),Object(O.createElement)(nn.a,{options:{forceBlock:!0,overrides:{h6:{component:yt.a,props:{variant:'h6'}},p:{component:yt.a,props:{variant:'body1'}},a:{component:on.a}}}},n)),Object(O.createElement)(fn.a,null,i.map((e,t)=>{const n=`card-${t}${Object(ye.format)(new Date,Fe)}`;return Object(O.createElement)(wt.a,{href:e.postback,target:'_blank',size:'small',color:'primary',key:n},e.text)})))}}var vn=Object(U.connect)((e)=>({inputValue:e.userInput}))(wn),Dn=n(49),Sn=n.n(Dn),kn=n(50),zn=n.n(kn),On=n(51),Pn=n.n(On),Un=n(52),An=n.n(Un),Yn=n(53),Rn=n.n(Yn),Qn=n(54),Vn=n.n(Qn),Bn=n(55),_n=n.n(Bn),Wn=n(56),Gn=n.n(Wn);const Hn=V()(Nn.a)`
  && {
    border-top-left-radius: 10px;
    border-top-right-radius: 10px;
    border-bottom-right-radius: 10px;
