...
import { response } from './../../test/textResponse'
  ...
  it('should handle SAVE_RESPONSE', () => {
    ...
    expect(
      reducer(exampleState, {
        ...
        client: new Client(options),
        clientOptions: options,
        newConversationArray: response,
      }).messages.queryResult.fulfillmentMessages
    ).toEqual([{"message": "text", "platform": "PLATFORM_UNSPECIFIED", "text": {"text": ["This is a test response"]}}]);
  });
